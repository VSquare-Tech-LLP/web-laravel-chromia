    ...
    <div class="container">
        <div class=" my-5 d-flex align-items-center justify-content-center">
            <div class="wrapper d-flex flex-column">
                ...
                <h1 class="text-center">FlxuMate - Ai Art Maker</h1>
                ...
                <p>Unleash your creativity with FluxMate, the ultimate AI art generator! Whether you’re an artist or just someone who loves
                exploring new forms of expression, FluxMate empowers you to create stunning visuals in seconds. Simply enter a prompt,
                select the size, and let our advanced AI turn your ideas into reality.</p>

                <p>Key Features:</p>

                <h3>Create Your Art:</h3>
                <p>Input a prompt, choose your preferred size, and watch as FluxMate transforms your words into beautiful images.</p>
                ...
                <p>With FluxMate, the only limit is your imagination. Generate endless art pieces and explore new creative horizons.</p>


                <p>Download FluxMate now and start creating your own masterpieces today!</p>
