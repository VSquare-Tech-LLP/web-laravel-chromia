...
<head>
    ...
    <style>
        :root{
            ...
            --secondary-color: {{config('settings_secondary_color') ?? '#f8fafc' }};
            --footer-bg: {{config('settings_footer_bg_color') ?? '#171717' }};
            --font-color: {{config('settings_font_color') ?? '#303030' }};
            --link-color: {{config('settings_link_color') ?? '#303030' }};
            --link-hover-color: {{config('settings_link_hover_color') ?? 'var(--primary-color)' }};
            --content-link-color: {{config('settings_content_link_color') ?? 'var(--primary-color)' }};
    ...
    @if(config('app.google_analytics_id'))
        <script type="text/javascript">
            var _gaq = _gaq || [];
            _gaq.push(['_setAccount', '{{config('app.google_analytics_id')}}']);
